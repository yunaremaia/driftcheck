...
- **49 detector modules** covering 50+ toolchains and file types
- **52 independent detectors** (including split environment detectors)
- **915 tests** with >95% code coverage
