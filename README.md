...
- **52 detector modules** covering 50+ toolchains and file types
- **60 independent detectors** (including split environment detectors)
- **946 tests** with >95% code coverage
