...
- **51 detector modules** covering 50+ toolchains and file types
- **59 independent detectors** (including split environment detectors)
- **934 tests** with >95% code coverage
