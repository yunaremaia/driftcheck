...
- **50 detector modules** covering 50+ toolchains and file types
- **53 independent detectors** (including split environment detectors)
- **928 tests** with >95% code coverage
